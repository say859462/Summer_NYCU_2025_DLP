...
def train(args):
    ...
    full_dataset = iCLEVRDataset(root_dir=args.workspace, transform=transform)
    ...
    save_dir = Path(args.workspace) / "checkpoints_best"
    if accelerator.is_main_process:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--workspace", type=str, default=".", help="Root directory")
